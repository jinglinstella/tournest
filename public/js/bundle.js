...
var login = function login(_x, _x2) {
  return (_ref2 = _ref2 || _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(email, password) {
    var res;
...
document.addEventListener('DOMContentLoaded', function () {
  var formElement = document.querySelector('.forgot-form');
  if (formElement) {
    formElement.addEventListener('submit', function (e) {
...
var sendResetPasswordEmail = function sendResetPasswordEmail(_x3) {
  return (_ref3 = _ref3 || _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(email) {
    var res;
...
document.addEventListener('DOMContentLoaded', function () {
  var formElement = document.querySelector('.form'); //must be .form NOT .reset-form, or token won't load!!!
  ...
  if (formElement) {
    formElement.addEventListener('submit', function (e) {
      ...
      var token = formElement.getAttribute('data-token');
...
var reset = function reset(_x4, _x5, _x6) {
  return (_ref4 = _ref4 || _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(password, passwordConfirm, token) {
    var res;
...
var signup = function signup(_x7, _x8, _x9, _x10) {
  return (_ref5 = _ref5 || _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(name, email, password, passwordConfirm) {
    var res;
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } /* eslint-disable */
var stripe = Stripe('pk_test_51NrZu7LteDnvhYGQKgZCVqwnjAUQGPh9wkQDqn7TkBkaNRg2wHe6ETXKpKG1BUmtGmo4BDAG0ZcdtAdmBSL6PbhP00WsbRod4J');
